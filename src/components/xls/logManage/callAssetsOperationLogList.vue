    ...
    export default {
        data() {
            return {
              ...
              options: {
                serviceType: [
                  //{value:'100',label:'商户入驻'},
                  //{value:'110',label:'风控进件'},
                  //{value:'120',label:'开立商户额度账户'},
                  //{value:'130',label:'开立商户资金账户'},
                  //{value:'140',label:'商户绑卡'},
                  {value:'160',label:'资匹分配资方ID'},
                  {value:'170',label:'资匹生成还款计划'},
                  {value:'180',label:'调用资匹取消'},
                  //{value:'190',label:'风控准入'},
                  //{value:'200',label:'用户绑卡'},
                  //{value:'210',label:'恢复信用额度'},
                  //{value:'220',label:'下单立减信用额度'},
                  {value:'230',label:'资匹回调'},
                  //{value:'240',label:'查询商户信用账户信息'},
                  //{value:'250',label:'风控审核回调'},
                  //{value:'260',label:'获取通讯录'},
                  {value:'270',label:'还款完成回调'}
                ],
                type: [
                  {value:1,label:'接受消息'},
                  {value:2,label:'请求消息'}
        ...
        methods: {
          ...
          queryList(){
            this.$axios.HttpPost('/select/log/callAssetsOperationLog',
              this.queryForm
            )
              .then((data) => {
