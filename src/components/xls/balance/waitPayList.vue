        ...
        <el-table
          ...
          <el-table-column
            ...
            <template slot-scope="scope">
              <el-button type="primary" size="mini" @click="pendingMoney(scope.row.orderSn)">确认放款</el-button>
            </template>
          </el-table-column>
        </el-table>
      </el-row>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      pendingMoney(orderSn){
        this.$axios.HttpGet('/api/seller/Settlement/pendingMoney/' + orderSn,
          {}
        )
          .then((data) => {
            this.$message({
