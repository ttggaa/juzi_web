        ...
        <el-form label-width="90px">
          <el-col :offset="1" :span="6">
            <el-form-item label="店铺名称">
              <el-input maxlength="30" v-model="queryForm.cateId" type="text" auto-complete="off"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="6">
      ...
      <div class="list">
          ...
          <el-table
            ...
            <el-table-column
              ...
              <template slot-scope="scope">
                <el-button @click="()=>{type='1';dialogVisible=true}" type="primary" size="mini">经营品类</el-button>
              </template>
            </el-table-column>
          </el-table>
        </el-row>
        ...
        <el-dialog
          ...
          <el-form label-width="90px">
            ...
            <el-form-item label="品类管理">
              <el-button size="mini" type="primary">增加品类</el-button>
            </el-form-item>
            <el-form-item label="品牌管理">
              <el-button size="mini" type="primary">增加品牌</el-button>
            </el-form-item>
          </el-form>
          <span slot="footer" class="dialog-footer">
